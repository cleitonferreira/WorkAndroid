...
public class CarActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener, DialogInterface.OnCancelListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // FAB
        // keytool -list -v -keystore /Users/user/.android/debug.keystore -alias androiddebugkey -storepass android -keypass android
    ...
    private void inviteCall(){
        Intent intent = new AppInviteInvitation.IntentBuilder("ExemploMaterialAppWidget")
