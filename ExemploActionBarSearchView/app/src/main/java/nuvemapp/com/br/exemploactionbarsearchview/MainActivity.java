...
public class MainActivity extends FragmentActivity {
    ...
    private class NavegacaoTabs implements ActionBar.TabListener {
        ...
        public void onTabSelected(Tab tab, android.app.FragmentTransaction ft) {
            // Seta o texto das Tabs no ícone a esquerda
    ...
    public class SearchFiltro implements SearchView.OnQueryTextListener {
        ...
        // Este método é chamado no submite da pesquisa
        @Override
        ...
        //Para cada valor que digitar ou apagar o texto - este método é chamado
        @Override
    ...
    public boolean onMenuItemSelected(int panel, MenuItem item){
        switch(item.getItemId()){
            case android.R.id.home:
                ...
                //voltar para o estador original - 1ª tela
