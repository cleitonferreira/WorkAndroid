...
public class NotificationConf implements Parcelable {
    ...
    public static final String STATUS_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.NotificationConf.STATUS_KEY";
    ...
    public static final Creator<NotificationConf> CREATOR = new Creator<NotificationConf>() {
