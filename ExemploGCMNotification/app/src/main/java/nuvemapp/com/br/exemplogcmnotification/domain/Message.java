...
public class Message implements Parcelable {
    ...
    public static final String MESSAGE_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.Message.MESSAGE_KEY";
    public static final String MESSAGES_SUMMARY_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.Message.MESSAGES_SUMMARY_KEY";
