package nuvemapp.com.br.exemplogcmnotification.domain;
...
public class User implements Parcelable {
    ...
    public static final String USER_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.User.USER_KEY";
    public static final String USER_TO_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.User.USER_TO_KEY";
    public static final String ID_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.User.ID_KEY";
    public static final String FIRST_TIME_KEY = "nuvemapp.com.br.exemplogcmnotification.domain.User.FIRST_TIME_KEY";
